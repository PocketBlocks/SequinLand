package net.pocketdreams.sequinland.event.executor.asm;
...
public class ASMEventExecutorGenerator {
    public static byte[] generateEventExecutor(Method m, String name) {
        ...
        methodGenerator = new GeneratorAdapter(writer.visitMethod(ACC_PUBLIC, "execute", "(Lcn/nukkit/event/Listener;Lcn/nukkit/event/Event;)V", null, null), ACC_PUBLIC, "execute", "(Lcn/nukkit/event/Listener;Lcn/nukkit/event/Listener;)V");;
    ...
    public static String generateName() {
        ...
        return "net.pocketdreamssequinland.event.executor.asm.generated.GeneratedEventExecutor" + id;
    }
}