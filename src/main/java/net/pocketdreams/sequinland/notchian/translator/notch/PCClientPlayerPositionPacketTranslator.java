...
public class PCClientPlayerPositionPacketTranslator extends NotchPacketTranslator {

    @Override
    public DataPacket[] translate(Packet packet, NotchianPlayer player) {
        ClientPlayerPositionPacket pcPacket = (ClientPlayerPositionPacket) packet;
