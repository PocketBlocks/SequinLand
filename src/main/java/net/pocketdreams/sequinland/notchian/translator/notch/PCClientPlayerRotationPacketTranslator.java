...
public class PCClientPlayerRotationPacketTranslator extends NotchPacketTranslator {

    @Override
    public DataPacket[] translate(Packet packet, NotchianPlayer player) {
        ClientPlayerRotationPacket pcPacket = (ClientPlayerRotationPacket) packet;
        ...
        pePacket.mode = MovePlayerPacket.MODE_ROTATION;
